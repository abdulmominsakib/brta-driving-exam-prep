...
class FeedbackBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = isCorrect
        ? (isDark ? const Color(0xFF1E3A00) : const Color(0xFFD7FFB8))
        : (isDark ? const Color(0xFF3F0000) : const Color(0xFFFFDFE0));
              ...
              Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: ShadTheme.of(context).colorScheme.background.withValues(alpha: 0.5),
