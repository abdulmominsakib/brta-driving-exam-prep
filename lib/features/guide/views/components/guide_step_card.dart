          ...
          child: Padding(
            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                final textStyle = theme.textTheme.muted.copyWith(height: 1.5);
                final span = TextSpan(text: step.content, style: textStyle);
                ...
                // Subtract padding (16*2) and border (roughly 2) from available width
                tp.layout(maxWidth: constraints.maxWidth - 34);
                final hasOverflow = tp.didExceedMaxLines;
                final canExpand = hasOverflow || step.loopBackText != null;
                      ...
                      children: [
                        ...
                        AnimatedCrossFade(
                          ...
                          secondChild: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(step.content, style: textStyle),
